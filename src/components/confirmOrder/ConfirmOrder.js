...
const {user} = useContext(AuthContext)
    ...
    return (
        <div className='lg:w-3/5 md:w-3/4 container lg:px-20 md:px-20 bg-base-100'>
            <div className="shadow-xl">
            <figure><img  className='w-full lg:h-96 h-56 object-cover' src={strMealThumb} alt="Shoes" /></figure>
  ...
  <div className="container px-5 py-10 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base font-bold">input your information to confirm order</p>
    </div>
      ...
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-1/2">
          <div className="relative">
            ...
            <input required  name="phone" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          </div>
        </div>
        <div className="p-2 w-1/2">
          <div className="relative">
