            ...
            <div className='flex justify-center my-5'>
                {
                    user?.photoURL ?
                        <div className="avatar ">
                            <div className="w-28 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 object-cover">
                                <img className='object-cover' src={user?.photoURL} alt="profile" />
                            </div>
                        </div>
                        :
                ...
                <form className="lg:w-1/2 md:w-2/3 mx-auto">
                    ...
                    }
                    {
                        ...
                        <div className="mt-5 flex justify-center items-center gap-5">
                            ...
                            <input  defaultValue={user?.email} readOnly required type="text" name="name" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                    }
