...
const Banner = () => {
    return (
        <div className='relative container'>
            <div className='absolute flex flex-col font-primary gap-3 lg:top-10 md:top-20 top-2 left-10 md:left-20 lg:left-20 text-white lg:text-8xl md:text-6xl text-2xl z-10'>
                <h1>Fastest</h1>
                <h1>Delivery &</h1>
                <h1>Easy Pickup</h1>
            </div>
            <div className='absolute left-10 md:left-20 lg:left-20 lg:bottom-40 md:bottom-40 bottom-8 lg:w-2/4 text-white z-10 lg:flex md:flex justify-start items-center gap-5'>
            ...
            <div>
                <figure>
                    <img className='w-screen lg:h-screen brightness-50  ' src={bannerImg} alt="" />
                </figure>
            </div>
        </div>
    );
